...
public class AdjacencyList implements Representation {
    ...
    public boolean addNode(Node x) {
        // add a node to the graph. return false if the node is already in the graph
        //and true if the node is added successfully
    ...
    public boolean removeNode(Node x) {
        // remove a node from the graph. return false if the node does not exist
    ...
    public boolean addEdge(Edge x) {
        // add an edge to the graph. return false if the edge is already in the graph
        // and true if the edge is added successfully
